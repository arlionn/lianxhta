...
# xtvfreg --   Varying fixed effects panel regression with heteroscedastic variance function

> Van Wijk, D., De Valk, H. A. G., & Liefbroer, A. C. (2025). Who becomes a parent while jobless? On the importance of limited opportunities and the normalization of disadvantage. European Sociological Review. [Link](https://doi.org/10.1093/esr/jcae052), [PDF](http://sci-hub.ren/10.1093/esr/jcae052), [Google](<https://scholar.google.com/scholar?q=Who becomes a parent while jobless? On the importance of limited opportunities and the normalization of disadvantage>).

- Stata：`ssc install xtvfreg, replace`
...
Rüttenauer, T., & Aksoy, O. (2024). When Can We Use Two-Way Fixed-Effects (TWFE): A Comparison of TWFE and Novel Dynamic Difference-in-Differences Estimators (Version 3). arXiv. [Link](https://doi.org/10.48550/arXiv.2402.09928) (rep), [PDF](https://arxiv.org/pdf/2402.09928.pdf), [Google](<https://scholar.google.com/scholar?q=When Can We Use Two-Way Fixed-Effects (TWFE): A Comparison of TWFE and Novel Dynamic Difference-in-Differences Estimators (Version 3)>).
- 1The code is available on the author’s GitHub repository [Link will be added].


# 基于深度学习的个体异质性效应估计

- Farrell, M. H., Liang, T., & Misra, S. (2025). Deep Learning for Individual Heterogeneity (Version 3). arXiv. [Link](https://doi.org/10.48550/arXiv.2010.14694) (rep), [PDF](https://arxiv.org/pdf/2010.14694.pdf), [Google](<https://scholar.google.com/scholar?q=Deep Learning for Individual Heterogeneity (Version 3)>).
  - Replication files are available at https://github.com/maxhfarrell/FLM2



# DDD-triplediff：三重差分模型深度解读

- Ortiz-Villavicencio, M., & Sant'anna, P. H. C. (2025). Better Understanding Triple Differences Estimators (Version 3). arXiv. [Link](https://doi.org/10.48550/arXiv.2505.09942) (rep), [PDF](https://arxiv.org/pdf/2505.09942.pdf), [Google](<https://scholar.google.com/scholar?q=Better Understanding Triple Differences Estimators (Version 3)>). 
  - `triplediff`: R package, is freely available on
GitHub to automate all these DDD estimators proposed in this article, simplifying their adoption for practitioners.
  - <https://marcelortiz.com/triplediff/>

# 
- Chernozhukov, V., Lee, S., Rosen, A. M., & Sun, L. (2025). Policy Learning with Confidence (Version 2). arXiv. [Link](https://doi.org/10.48550/arXiv.2502.10653) (rep), [PDF](https://arxiv.org/pdf/2502.10653.pdf), [Google](<https://scholar.google.com/scholar?q=Policy Learning with Confidence (Version 2)>).

# 

- Picchetti, P. (2025). Breakdown Analysis for Instrumental Variables with Binary Outcomes (Version 4). arXiv. [Link](https://doi.org/10.48550/arXiv.2507.10242) (rep), [PDF](https://arxiv.org/pdf/2507.10242.pdf), [Google](<https://scholar.google.com/scholar?q=Breakdown Analysis for Instrumental Variables with Binary Outcomes (Version 4)>).


# wals命令介绍

- Luca, G. D., & Magnus, J. R. (2025). Weighted-average least squares: Improvements and extensions. The Stata Journal, 25(3), 587–626. [Link](https://journals.sagepub.com/doi/10.1177/1536867X251365494), [PDF](http://www.janmagnus.nl/papers/stata-1.pdf), [Google](<https://scholar.google.com/scholar?q=Weighted-average least squares: Improvements and extensions>).

# netivreg：

Estrada, P., Estrada, J., Huynh, K. P., Jacho-Chávez, D., & Sánchez-Aragón, L. (2025). netivreg: Estimation of peer effects in endogenous social networks. The Stata Journal, 25(2), 344–373. [Link](https://journals.sagepub.com/doi/10.1177/1536867X251341145), [PDF](https://journals.sagepub.com/doi/pdf/10.1177/1536867X251341145), [Google](<https://scholar.google.com/scholar?q=netivreg: Estimation of peer effects in endogenous social networks>).

# tvpreg-tvpplot：

Inoue, A., Rossi, B., Wang, Y., & Zhou, L. (2025). Parameter path estimation in unstable environments: The tvpreg command. The Stata Journal, 25(2), 374–406. [Link](https://journals.sagepub.com/doi/10.1177/1536867X251341170), [PDF](https://journals.sagepub.com/doi/pdf/10.1177/1536867X251341170), [Google](<https://scholar.google.com/scholar?q=Parameter path estimation in unstable environments: The tvpreg command>).

# 分位数控制法

Yan, G., Chen, Q., & Xiao, Z. (2025). Quantile control method: Causal inference with one treated unit via random forest. The Stata Journal, 25(2), 407–437. [Link](https://journals.sagepub.com/doi/10.1177/1536867X251341181), [PDF](https://journals.sagepub.com/doi/pdf/10.1177/1536867X251341181), [Google](<https://scholar.google.com/scholar?q=Quantile control method: Causal inference with one treated unit via random forest>).

# 
Cox, N. J. (2025). Stata tip 162: Add marginal rugs using marker symbols or axis ticks. The Stata Journal, 25(2), 491–497. [Link](https://journals.sagepub.com/doi/10.1177/1536867X251341426), [PDF](https://journals.sagepub.com/doi/pdf/10.1177/1536867X251341426), [Google](<https://scholar.google.com/scholar?q=Stata tip 162: Add marginal rugs using marker symbols or axis ticks>).


# tabagree
Falcaro, M., & Newson, R. B. (2025). tabagree: Nonparametric measures of agreement and disagreement in paired ordinal data. The Stata Journal, 25(3), 627–645. [Link](https://journals.sagepub.com/doi/10.1177/1536867X251365495), [PDF](https://journals.sagepub.com/doi/pdf/10.1177/1536867X251365495), [Google](<https://scholar.google.com/scholar?q=tabagree: Nonparametric measures of agreement and disagreement in paired ordinal data>).

- In this article, we describe `tabagree`, a new command for assessing the level of agreement and disagreement in paired ordinal data. tabagree implements some of the nonparametric measures proposed by Svensson (1993, Analysis of Systematic and Random Differences Between Paired Ordinal Categorical Data [Almqvist and Wiksell]) and allows the user to evaluate systematic disagreement separately from random differences. For example, the command can be used in interrater and intrarater reliability studies or in analyses of change.

# ctl：
Taffé, P. (2025). ctl: A package for assessing agreement based on clinical tolerance limits. The Stata Journal, 25(3), 659–676. [Link](https://journals.sagepub.com/doi/10.1177/1536867X251365501), [PDF](https://journals.sagepub.com/doi/pdf/10.1177/1536867X251365501), [Google](<https://scholar.google.com/scholar?q=ctl: A package for assessing agreement based on clinical tolerance limits>).

# gintreg

Mcdonald, J. B., & Triplett, J. (2025). gintreg: Generalized interval regression. The Stata Journal, 25(1), 51–76. [Link](https://journals.sagepub.com/doi/10.1177/1536867X251322961), [PDF](https://journals.sagepub.com/doi/pdf/10.1177/1536867X251322961), [Google](<https://scholar.google.com/scholar?q=gintreg: Generalized interval regression>).
...
Bottai, M. (2025). Maximum agreement regression with magreg. The Stata Journal, 25(1), 237–243. [Link](https://journals.sagepub.com/doi/10.1177/1536867X251322972), [PDF](https://journals.sagepub.com/doi/pdf/10.1177/1536867X251322972), [Google](<https://scholar.google.com/scholar?q=Maximum agreement regression with magreg>).
- 需要自行想办法下载 PDF 原文

# 翻译：基尼系数简明讲义

1. 翻译 Victor Zhou, Blog, 2019. [A Simple Explanation of Gini Impurity](https://victorzhou.com/blog/gini-impurity/)。务必注明完整出处
2. 以此为基础，自行查阅资料，做适当扩展。尤其是该指标在经济学和机器学习领域的应用。可以借助 AI 生成，但需要修改润色，避免 AI 痕迹过重
3. 增加一个 Section，介绍一些 Stata 和 Python 的实现方法和例子。

---

Note: 可以参考如下写法实现文中的绿色和蓝色圆点的写法

- A dataset of only blues <span style="color: #1f77b4;">● ● ● ●</span> would have very **low** (in fact, zero) entropy.

- A dataset of mixed blues, greens, and reds <span style="color: #1f77b4;">● ●</span> <span style="color: #2ca02c;">● ●</span> <span style="color: #d62728;">● ●</span> would have relatively **high** entropy.

# 翻译：人工神经网络易懂教程 

翻译如下推文。
- 可以借助 AI 生成，但需要修改润色，避免 AI 痕迹过重。
- 文中的数学公式要用 Latex 公式
- 文中的图片要上传到连享会图床后再插入推文中。note: 可以右击图片，选择“复制图片”，然后将图片贴入 PicGo 软件中，自动上传到图床，获取图片链接。

- Victor Zhou, Blog, 2022. Machine Learning for Beginners: An Introduction to Neural Networks: A simple explanation of how they work and how to implement one from scratch in Python. [-Link-](https://victorzhou.com/blog/intro-to-neural-networks/)
...
- Victor Zhou, Blog, 2019. CNNs, Part 1: An Introduction to Convolutional Neural Networks - A simple guide to what CNNs are, how they work, and how to build one from scratch in Python. [-Link-](https://victorzhou.com/blog/intro-to-cnns-part-1/) 
...
Victor Zhou, Blog, 2019. CNNs, Part 2: CNNs, Part 2: Training a Convolutional Neural Network - A simple walkthrough of deriving backpropagation for CNNs and implementing it from scratch in Python. [-Link-](https://victorzhou.com/blog/intro-to-cnns-part-2/) 
...
- Victor Zhou, Blog, 2019. Random Forests for Complete Beginners: The definitive guide to Random Forests and Decision Trees. [-Link-](https://victorzhou.com/blog/intro-to-random-forests/)
...
Spector, A., Barber, R. F., & Candès, E. (2025). Mosaic inference on panel data (Version 1). arXiv. [Link](https://doi.org/10.48550/arXiv.2506.03599) (rep), [PDF](https://arxiv.org/pdf/2506.03599.pdf), [Google](<https://scholar.google.com/scholar?q=Mosaic inference on panel data (Version 1)>). [github](https://github.com/amspector100/mosaic_panel_paper)

# twc_inf：二维聚类稳健标准误

> [ChatGPT 对话过程](https://chatgpt.com/share/6912094c-26a4-8005-a8db-1483ea679ab0)

Davezies, L., D'haultfœuille, X., & Guyonvarch, Y. (2025). Analytic inference with two-way clustering (Version 1). arXiv. [Link](https://doi.org/10.48550/arXiv.2506.20749) (rep), [PDF](https://arxiv.org/pdf/2506.20749.pdf), [Google](<https://scholar.google.com/scholar?q=Analytic inference with two-way clustering (Version 1)>).

## Stata 实现

We develop the Stata package `twc_inf`, available on SSC, which implements this method for linear,
probit, logit and poisson regressions.

```stata
ssc install twc_inf, replace 
```

作者还提供了Stata 范例 codes 和数据文件，下载方法为：

```
net get twc_inf.pkg, replace 
```

执行后，会自动将 `testing_twc_inf.do` 和 `twc_inf_db.dta` 文件下载到当前工作路径下。 


# xtregtfb

Chen, K., & Vogelsang, T. J. (2024). Fixed-b asymptotics for panel models with two-way clustering. Journal of Econometrics, 244(1), 105831. [Link](https://doi.org/10.1016/j.jeconom.2024.105831), [PDF](http://sci-hub.ren/10.1016/j.jeconom.2024.105831), [Google](<https://scholar.google.com/scholar?q=Fixed-b asymptotics for panel models with two-way clustering>).
...
# 介绍 Software Heritage 网站

https://www.softwareheritage.org/

- 快速搜索 github 仓库
  - 编写程序，通过 API 批量获取某个作者的所有 github 仓库的 SWHID
  - 例如，获取 `d2cml-ai` 组织下的所有仓
- 保存代码快照
  - 通过 SWHID，可以永久保存某个时间点的代码状态
  - 适合论文复现，确保代码不会丢失或被篡改


# OpenICPSR数据平台的使用

- 网址：https://www.icpsr.umich.edu/web/ICPSR

请参照如下两篇推文的模式：
  - 连小白, 2025, [EJD平台：13000篇顶刊论文的复现数据和代码](https://www.lianxh.cn/details/1701.html).
  - 连小白, 2025, [Kaggle-数据科学平台：找数据、搜代码一网打尽](https://www.lianxh.cn/details/1586.html).
...
- 网址：<https://dataverse.harvard.edu/dataverse/harvard>
...
- [User Guide](https://guides.dataverse.org/en/6.8/user/)
...
> YouTube 介绍视频：<https://youtu.be/MPQ0Tpgaxt0>
...
![Harvard-dataverse-01-category](https://fig-lianxh.oss-cn-shenzhen.aliyuncs.com/Harvard-dataverse-01-category.png)
...
### 一些常见期刊的 Dataverse 链接

- [American Economic Journal: Applied Economics Dataverse](https://dataverse.harvard.edu/dataverse/aejapp)
- [American Economic Journal: Economic Policy Dataverse](https://dataverse.harvard.edu/dataverse/aejpol)
- [American Economic Journal: Macroeconomics Dataverse](https://dataverse.harvard.edu/dataverse/aejmacro)
- [American Economic Journal: Microeconomics Dataverse](https://dataverse.harvard.edu/dataverse/aejmicro)
- [American Journal of Political Science Dataverse](https://dataverse.harvard.edu/dataverse/ajps)
- [Journal of Political Economy Dataverse](https://dataverse.harvard.edu/dataverse/jpe)
- [Quarterly Journal of Economics Dataverse](https://dataverse.harvard.edu/dataverse/qje)
- [Review of Economic Studies Dataverse](https://dataverse.harvard.edu/dataverse/restud)
- [Review of Economics and Statistics Dataverse](https://dataverse.harvard.edu/dataverse/restats)
- [Science Dataverse](https://dataverse.harvard.edu/dataverse/science)
- [The American Economic Review Dataverse](https://dataverse.harvard.edu/dataverse/aer)
- [The Journal of Finance Dataverse](https://dataverse.harvard.edu/dataverse/jofi)
- [The Journal of Financial Economics Dataverse](https://dataverse.harvard.edu/dataverse/jfec)
- **JFQA** ([Journal of Financial and Quantitative Analysis](https://www.cambridge.org/core/journals/journal-of-financial-and-quantitative-analysis)), [dataverse/JFQA](https://dataverse.harvard.edu/dataverse/jfqa) (from 2024)
- [Financial Management](https://dataverse.harvard.edu/dataverse/FMA) (from 2023)
- [Review of Corporate Finance Studies](https://dataverse.harvard.edu/dataverse/rcfs)


## 高级检索

截图或采用列表、实例的方式，介绍 [高级检索](https://dataverse.harvard.edu/dataverse/harvard/search) 功能，以便读者能快速搜索到符合特定要求的数据集。

## 创建账户

参考 [For Researchers](https://support.dataverse.harvard.edu/researchers) 页面的介绍，说明使用 Harvard Dataverse 管理个人研究数据集的步骤和优势。 

点击 [Sign up](https://dataverse.harvard.edu/dataverseuser.xhtml?editMode=CREATE&redirectPage=%2Fdataverseuser.xhtml) 创建账户。

- [Daniel Aldrich Dataverse](https://dataverse.harvard.edu/dataverse/daldrich)

# 合成DID的Python实现

可以引用此前的推文作为理论分析部分。

汇总介绍 SDID 的 Stata, R, Python 实现代码和相关资料。
...
- [Using Surrogate Indices to Estimate Long-Run Heterogeneous Treatment Effects of Membership Incentives](https://tech.instacart.com/instacarts-economics-team-using-surrogate-indices-to-estimate-long-run-heterogeneous-treatment-0bf7bc96c6e6)
...
# tdid：双重稳健三重差分估计量(DR-DDD)-R语言

Leventer, D. (2025). Conditional Triple Difference-in-Differences (Version 3). arXiv. [Link](https://doi.org/10.48550/arXiv.2502.16126) (rep), [PDF](https://arxiv.org/pdf/2502.16126.pdf), [Google](<https://scholar.google.com/scholar?q=Conditional Triple Difference-in-Differences (Version 3)>). [Website-tdid](https://dorleventer.github.io/tdid/), [github](https://github.com/dorleventer/tdid)
- An accompanying R package for implementation code is available at `tdid`.
...
Yang, X., Lin, L., Athey, S., Jordan, M. I., & Imbens, G. W. (2025). Cross-Validated Causal Inference: a Modern Method to Combine Experimental and Observational Data (Version 1). arXiv. [Link](https://doi.org/10.48550/arXiv.2511.00727) (rep), [PDF](https://arxiv.org/pdf/2511.00727.pdf), [Google](<https://scholar.google.com/scholar?q=Cross-Validated Causal Inference: a Modern Method to Combine Experimental and Observational Data (Version 1)>).

- https://github.com/xyang23/cross_validated_causal

# PanelIFE：带交互固定效应的面板数据稳健估计和推断-R语言

- Armstrong, T. B., Weidner, M., & Zeleneev, A. (2025). Robust Estimation and Inference in Panels with Interactive Fixed Effects (Version 4). arXiv. [Link](https://doi.org/10.48550/arXiv.2210.06639) (rep), [PDF](https://arxiv.org/pdf/2210.06639.pdf), [Google](<https://scholar.google.com/scholar?q=Robust Estimation and Inference in Panels with Interactive Fixed Effects (Version 4)>).
  - R is also available at <https://github.com/chenweihsiang/PanelIFE>.


# multinomSelection：多元Logit中的样本选择偏误-R语言实现

Boussim, O. (2025). Correcting sample selection bias with categorical outcomes (Version 2). arXiv. [Link](https://doi.org/10.48550/arXiv.2510.05551) (rep), [PDF](https://arxiv.org/pdf/2510.05551.pdf), [Google](<https://scholar.google.com/scholar?q=Correcting sample selection bias with categorical outcomes (Version 2)>). [github](https://onilboussim.github.io/)

- `multinomSelection`, R package, <https://onilboussim.github.io/>
- 
# 弱工具变量推断详解及Python实操

- Londschien, M. (2025). A statistician's guide to weak-instrument-robust inference in instrumental variables regression with illustrations in Python (Version 1). arXiv. [Link](https://doi.org/10.48550/arXiv.2508.12474) (rep), [PDF](https://arxiv.org/pdf/2508.12474.pdf), [Google](<https://scholar.google.com/scholar?q=A statistician's guide to weak-instrument-robust inference in instrumental variables regression with illustrations in Python (Version 1)>).



# 基于IV的因果中介效应模型-R语言实现

Hogan-Hennessy, S. (2025). Causal Mediation in Natural Experiments (Version 2). arXiv. [Link](https://doi.org/10.48550/arXiv.2508.05449) (rep), [PDF](https://arxiv.org/pdf/2508.05449.pdf), [Google](<https://scholar.google.com/scholar?q=Causal Mediation in Natural Experiments (Version 2)>). [Slides](https://raw.githubusercontent.com/shoganhennessy/mediation-natural-experiment/main/presentation-2025.pdf)
- github: <https://github.com/shoganhennessy/mediation-natural-experiment>

![20251117021020](https://fig-lianxh.oss-cn-shenzhen.aliyuncs.com/20251117021020.png)

# 序列合成双重差分法（Sequential SDiD，SSDiD）
- Arkhangelsky, D., & Samkov, A. (2024). Sequential Synthetic Difference in Differences (Version 2). arXiv. [Link](https://doi.org/10.48550/arXiv.2404.00164) (rep), [PDF](https://arxiv.org/pdf/2404.00164.pdf), [Google](<https://scholar.google.com/scholar?q=Sequential Synthetic Difference in Differences (Version 2)>).
  - 写作建议：可以参考或翻译 <https://www.diddigest.xyz/p/efficient-estimation-sequential-synthetic> 中的内容作为本推文的简介。其他内容可以借助 AI 完成，然后手
  - 我们提出序列合成双重差分法（Sequential SDiD）估计量，适用于交错实施处理的事件研究，尤其针对平行趋势假设不成立的场景。该方法基于汇总数据采用迭代插补流程，利用早期处理组的估计结果为后续组别构建反事实。我们证明，在线性交互固定效应模型中，该估计量与不可行的理想 OLS 估计量渐近等价。这一核心理论结果通过确立渐近正态性、明确估计量的有效性，为标准统计推断提供了基础。序列合成双重差分法具备稳健性与透明度，且有正式统计性质保障，是传统双重差分策略的有力替代方案。

序列合成双重差分法（Sequential SDiD）与合成DID（Synthetic DID，简称SDiD）均用于处理交错实施处理的事件研究，但核心逻辑和适用场景存在显著差异，具体区别如下：


| **维度**         | **合成DID（SDiD）**                                                                                                                           | **序列合成DID（Sequential SDiD）**                                                                                                               |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| **核心逻辑**     | 基于“合成控制”思想，为每个处理组构建一个由未处理单元加权组合的“合成控制组”，通过对比处理组与合成组的差异估计效应，本质是对传统DID的加权拓展。 | 采用“迭代递推”思路，先估计早期处理组的效应，再用这些结果为后续处理组构建反事实（无需依赖未处理单元直接加权），通过分步迭代减少对平行趋势的依赖。 |
| **平行趋势依赖** | 仍要求处理组与合成控制组满足近似平行趋势，若该假设严重不成立，估计可能偏误。                                                                  | 明确针对平行趋势假设不成立的场景，通过早期组信息迭代修正后期组反事实，对平行趋势的敏感性更低。                                                   |
| **数据利用方式** | 主要依赖未处理单元（或“永不处理”单元）的信息构建合成控制组，对未处理单元数量和质量较敏感。                                                    | 更侧重利用已处理的早期组信息（而非未处理单元），即使未处理单元少或质量差，仍可通过迭代流程稳健估计。                                             |
| **理论基础**     | 基于加权DID框架，通过权重优化使合成组与处理组事前特征匹配，保障估计一致性。                                                                   | 在线性交互固定效应模型中被证明与“理想OLS估计量”渐近等价，理论上更明确统计性质（如渐近正态性、效率）。                                            |
| **适用场景**     | 适用于平行趋势近似成立、未处理单元充足且能较好匹配处理组的交错处理场景。                                                                      | 更适合平行趋势假设明显不成立、未处理单元稀缺或质量低的场景，尤其适合处理时间跨度长、批次多的研究。                                               |


简言之，合成DID是“静态匹配”思路，依赖未处理单元构建反事实；而序列合成DID是“动态迭代”思路，利用早期处理组信息修正后期反事实，对平行趋势的宽容度更高，适用范围更偏向假设不满足的复杂场景。
...
双重差分法（DID）是估计处理效应的常用方法，但在数据因隐私问题或数据共享的法律限制（尤其跨辖区场景）无法合并时，该方法难以适用。本研究识别并放宽了双重差分估计中数据可合并的假设，提出一种创新的非合并数据双重差分法（UN-DID），可纳入协变量、支持多组别及交错实施场景。通过理论证明和蒙特卡洛模拟验证，无协变量时，UN-DID 与传统 DID 的平均处理效应估计值、标准误完全一致且无偏；纳入协变量后，两种方法的估计结果同样无偏等效，均收敛于真实值，仅存在微小差异，且统计推断与核心结论保持不变。两项基于真实数据的实证案例进一步印证了 UN-DID 的实用性。该方法允许利用非合并数据估计跨辖区处理效应，助力更优反事实分析的开展和新研究问题的解答。
...
Deb, N., Dwivedi, R., & Basu, S. (2025). Counterfactual Forecasting For Panel Data (Version 1). arXiv. [Link](https://doi.org/10.48550/arXiv.2511.06189) (rep), [PDF](https://arxiv.org/pdf/2511.06189.pdf), [Google](<https://scholar.google.com/scholar?q=Counterfactual Forecasting For Panel Data (Version 1)>).
